<template>
  <section class="wh_container">
    <div class="wh_content_all">
      ...
      <div class="wh_content week_wh_content">
...
export default {
  ...
  methods: {
    ...
    clickDay: function (item, index) {
      ...
      let chooseDate = new Date(dateArr[0],dateArr[1]-1,dateArr[2]);
      // if(toDay.getTime()<chooseDate.getTime()){
      //   console.log("不能选择今天以后的时间")
      //   this.$message({
      //     message:"不能选择今天以后的时间",
      //     duration:2000,
      //     showColse:true
...
.week_wh_content .wh_content_item .wh_top_tag {
    color: #005F8F;
}
